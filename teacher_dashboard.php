            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
                ...
                <div class="mt-4 md:mt-0">
                    <a href="add_result.php"
                        class="flex items-center px-4 py-2 bg-blue-900 text-white rounded-md text-sm font-medium hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-900 transition-colors">
                    ...
                    <?php if (isset($top_student['name'])): ?>
                        <div class="flex items-center">
                            <div class="bg-blue-100 p-3 rounded-full">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-blue-900" fill="none"
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-sm text-slate-500">GPA: <span
                                        class="font-semibold text-green-600"><?php echo $top_student['gpa']; ?></span></p>
                            </div>
                        </div>
                    <?php else: ?>
                ...
                <div class="overflow-x-auto">
                    <table class="performance-table w-full rounded-lg overflow-hidden">
                        ...
                        <tbody class="bg-white divide-y divide-slate-200">
                                ...
                                <?php while ($row = $class_performance->fetch_assoc()) { ?>
                                    <tr>
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap text-center">
                                            <a href="edit_result.php?student_id=<?php echo $row['student_id']; ?>&subject_id=<?php echo $teacher['subject_id']; ?>"
                                                class="text-blue-900 hover:text-blue-700 mx-1">
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="6" class="px-4 py-3 text-center text-slate-500">No student records found.
                                    </td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
